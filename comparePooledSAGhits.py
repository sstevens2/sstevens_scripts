...
if __name__ == '__main__':
	...
	if pooled:
		...
		input = pd.read_table(filename,delim_whitespace=True, header=None, index_col=False, names=['read','ref_info','PID','align_len','mismatches','gaps','q_start','q_end','s_start','s_end','evalue','bit_score'])
